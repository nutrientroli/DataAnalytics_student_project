...
# F) number of sesions of the user
  ...
  resultKFour = CalculateClusteringWIthKmeans(usersAglomeratedData,4,50)
  resultKTen = CalculateClusteringWIthKmeans(usersAglomeratedData,10,50)
 ...
 # FALTA HACER LOS PLOTS Y LOS COMENTARIOS 
